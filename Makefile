...
TOOLPREFIX := $(shell if riscv64-unknown-elf-objdump -i 2>&1 | grep 'elf64-big' >/dev/null 2>&1; \
	...
	elif riscv-none-elf-objdump -i 2>&1 | grep 'elf64' >/dev/null 2>&1; \
...
# Unconditionally force 64-bit compilation
CFLAGS += -march=rv64g -mabi=lp64 -Wno-error=incompatible-pointer-types
