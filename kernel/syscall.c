...
extern uint64 sys_israeli_score_inc(void);
extern uint64 sys_israeli_score_get(void);
...
[SYS_israeli_score_inc] sys_israeli_score_inc,
[SYS_israeli_score_get] sys_israeli_score_get,
